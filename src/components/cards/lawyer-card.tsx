...
export function LawyerCard({ lawyer }: { lawyer: Lawyer }) {
  return (
    <Link href={`/lawyers/${lawyer.slug}`} className="frost group block h-full p-3 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      <h3 className="text-lg text-foreground">{lawyer.name}</h3>

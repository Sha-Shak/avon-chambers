...
export function JobCard({ job }: { job: JobPostMeta }) {
  return (
    <article className="flex flex-col justify-between gap-6 border-t border-navy/15 py-8 sm:flex-row sm:items-center">
      <div>
        ...
        <p className="mt-3 max-w-xl text-sm leading-relaxed text-slate">{job.summary}</p>
      ...
      <Link
        ...
        className="inline-flex shrink-0 items-center gap-2 text-[0.75rem] tracking-[0.14em] text-navy uppercase"
      >
